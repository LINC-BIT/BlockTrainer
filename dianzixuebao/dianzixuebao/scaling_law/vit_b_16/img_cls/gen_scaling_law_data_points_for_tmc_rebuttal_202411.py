...
if __name__ == '__main__':
    ...
    #     hyps={
    #         'sparsity': 0.875,
    #         'optional_batch_sizes': [256],
    #         'max_num_trials': 5000,
            
    #         'obtain_features_num_iters': 1, # random seed: 1
    ...
    #         'retraining_hyps': {
    #             'train_batch_size': 256, # std batch_size
    ...
    alg.run_real_target(
        ...
        hyps={
            ...
            'retraining_model_cls': FeatureAlignmentModel_ViTImageClassification,
            'retraining_hyps': {
                'train_batch_size': 4, # std batch_size
                'val_batch_size': 1024, # num samples for evaluating retraining accuracy
                'num_workers': 16,
                'optimizer': 'AdamW',
                'optimizer_args': {'lr': 3e-4}, # std lr for batch_size=64
