...
if __name__ == '__main__':
    ...
    from dnns.llama import AttentionPrunableLlamaForCausalLM, LlamaConfig, get_tokenizer
    tokenizer = get_tokenizer()
    model = AttentionPrunableLlamaForCausalLM.from_config(LlamaConfig(**config))
    ...
    qkv_layers = [[f'model.layers.{i}.self_attn.q_proj', 
                  ...
                  for i in range(62)]
    proj_layers = [f'model.layers.{i}.self_attn.o_proj' for i in range(62)]
    ff1_layers = [[f'model.layers.{i}.mlp.gate_proj', f'model.layers.{i}.mlp.up_proj'] for i in range(62)]
    ff2_layers = [f'model.layers.{i}.mlp.down_proj' for i in range(62)]
